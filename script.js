document.addEventListener("DOMContentLoaded", () => {
  ...
  if (typingElement) {
    ...
    const coolMessage = "Let’s Team Up and Build!"; // Customize this
    const separator = " - ";
    let phase = 0; // 0 = typing designations, 1 = deleting, 2 = typing cool message, 3 = deleting
    let textIndex = 0;
    let charIndex = 0;
    let typingSpeed = 100;
    ...
    function animateText() {
      ...
      if (phase === 0) {
        ...
        if (charIndex < currentText.length) {
          ...
          if (textIndex < designations.length - 1) {
            ...
            phase = 1; // Move to deleting phase
        ...
        if (charIndex > 0) {
          ...
          phase = 2; // Move to typing cool message
          typingSpeed = 500;
        }
      } else if (phase === 2) {
        // Typing cool message
        ...
        if (charIndex < currentText.length) {
          ...
          phase = 3; // Move to deleting cool message
          typingSpeed = 1500; // Pause before deleting
        }
      } else if (phase === 3) {
        // Deleting cool message
        currentText = coolMessage;
        if (charIndex > 0) {
          charIndex--;
          typingSpeed = 30;
      ...
      // Display the current text with gradient and cursor
...
const experienceData = [
  {
    ...
    duration: "6 Months - Stralynn.Inc",
    description:
  ...
  },
  {
    ...
    duration: "6 Months - Stralynn.Inc",
    description:
      "Built and deployed live AI agents and user-friendly UIs for the company. Developed advanced AI/ML models and end-to-end automation workflows, creating intuitive interfaces that simplified processes and presented data clearly for all stakeholders.",
  },
...
if (downloadCvBtn) {
  downloadCvBtn.addEventListener("click", () => {
    ...
    link.href = cvUrl;
    link.download = "Resume.pdf"; // Customize the filename
    link.click();
  });
}
